...
#ifndef _XSCHED_XCU_GROUP_H
#define _XSCHED_XCU_GROUP_H

#include <linux/idr.h>
#include "xsched_ioctl.h"
#include "uda_pub_def.h"

#define XSCHED_NR_CUS UDA_UDEV_MAX_NUM
...
struct xcu_group {
	...
	/* Amount of left node in XCU group tree */
...
int xcu_group_attach(
	struct xcu_group *new_group, struct xcu_group *previous_group);
