...
typedef volatile struct LEAPIORAID_SYSTEM_INTERFACE_REGS {
	U32 Doorbell;
	U32 WriteSequence;
	U32 HostDiagnostic;
	U32 Reserved1;
...
typedef struct LEAPIORAID_SCSI_IO_REQUEST_DESCRIPTOR \
...
typedef struct LEAPIORAID_SCSI_IO_SUCCESS_REPLY_DESCRIPTOR \
