...
static int ps3_r1x_hash_bit_lock(struct ps3_r1x_lock_mgr *mgr, struct ps3_cmd *cmd)
{
	int ret = PS3_SUCCESS;
	unsigned int i = 0;
	unsigned char item_cnt = 0;
...
static int ps3_r1x_hash_range_lock(struct ps3_r1x_lock_mgr *mgr, struct ps3_cmd *cmd)
{
	int ret = PS3_SUCCESS;
