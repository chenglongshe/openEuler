...
#define CACHE_ALIGNED (__aligned(64))
#endif

#ifndef ALIGNED
#define ALIGNED(a) (__aligned__(a))
#endif
...
#ifndef ALIGN_FLOOR
#define ALIGN_FLOOR(val, cacheLineSize) ((val) & (~((cacheLineSize) - 1)))
#endif
#ifndef ALIGN
...
#define PS3_SIZE_OF_TYPE_IS_ALIGN_OF(type, alignSize)                          \
	static inline char size_of_##type##_is_align_of_##alignSize(void)          \
	{                                                                      \
...
#define PS3_SIZE_OF_TYPE_EQUAL_WITH(type, size)                                \
	static inline char size_of_##type##_equal_with_##size1(void)               \
	{                                                                      \
		char __dummy1[size - sizeof(type)];                            \
		return __dummy1[-1];                                           \
	}                                                                      \
	static inline char size_of_##type##_equal_with_##size2(void)               \
	{                                                                      \
