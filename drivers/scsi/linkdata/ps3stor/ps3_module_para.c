...
static unsigned int g_err_inject[PS3_MAX_ERR_INJECT];
static unsigned int num_inject;
static unsigned int g_enable_inject;
module_param_array(g_err_inject, uint, &num_inject, 0);
MODULE_PARM_DESC(g_err_inject, "Err inject array. Default: 0");
module_param(g_enable_inject, uint, 0644);
