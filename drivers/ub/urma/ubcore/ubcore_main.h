...
int ubcore_negotiate_version(struct ubcore_msg_nego_ver_req *req, uint32_t *ver,
			     uint32_t *cap);
int ubcore_recv_net_addr_update(struct ubcore_device *mue_dev,
...
int ubcore_send_eid_update_req(struct ubcore_device *dev,
			       ...
			       uint32_t *upi);
int ubcore_recv_eid_update_req(struct ubcore_device *mue_dev,
			       struct ubcore_req_host *req);
