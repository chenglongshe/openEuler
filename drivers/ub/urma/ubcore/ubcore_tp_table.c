...
{
	struct ubcore_tp_node *tp_node =
		container_of(ref_cnt, struct ubcore_tp_node, ref_cnt);
...
static void ubcore_tptable_release(struct kref *kref)
{
	struct ubcore_hash_table *ht =
		container_of(kref, struct ubcore_hash_table, kref);
...
struct ubcore_tp_node *ubcore_add_tp_node(struct ubcore_hash_table *ht,
					  uint32_t hash,
					  const struct ubcore_tp_key *key,
					  struct ubcore_tp *tp,
					  struct ubcore_ta *ta)
...
struct ubcore_tp_node *ubcore_lookup_tpnode(struct ubcore_hash_table *ht,
					    uint32_t hash,
					    const struct ubcore_tp_key *key)
{
