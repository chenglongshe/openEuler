...
static const struct genl_ops ubcore_genl_ops[] = {
	...
	{
		.cmd = UBCORE_CMD_MUE2UE_RESP,
		.validate = GENL_DONT_VALIDATE_STRICT | GENL_DONT_VALIDATE_DUMP,

		.flags = GENL_ADMIN_PERM,
		.doit = ubcore_mue2ue_resp_ops,
	},
	{
	...
	{
		.cmd = UBCORE_CMD_UPDATE_MUE_DEV_INFO_RESP,
		.validate = GENL_DONT_VALIDATE_STRICT | GENL_DONT_VALIDATE_DUMP,

		.flags = GENL_ADMIN_PERM,
		.doit = ubcore_update_mue_dev_info_resp_ops,
	},
	{
		...
		.flags = GENL_ADMIN_PERM,
		.doit = ubcore_tp2ue_vtp_status_notify_ops,
	},
	{ .cmd = UBCORE_CMD_MSG_ACK,
		.validate = GENL_DONT_VALIDATE_STRICT | GENL_DONT_VALIDATE_DUMP,
		.flags = GENL_ADMIN_PERM,
		.doit = ubcore_nl_msg_ack_ops,
	},
};
					 ...
					 unsigned long action, void *data)
{
	...
	ubcore_unset_genl_pid_ops(notify->portid);
	return NOTIFY_DONE;
}
