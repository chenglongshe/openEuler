...
#define TX_OPAQUE_BDS(opq)	(((opq) & TX_OPAQUE_BDS_MASK) >>	\
				 TX_OPAQUE_BDS_SHIFT)
#define TX_OPAQUE_PROD(opq)	(TX_OPAQUE_IDX(opq) + TX_OPAQUE_BDS(opq))
...
#define RX_RING(x)	(((x) & bp->rx_ring_mask) >> (BNXT_PAGE_SHIFT - 4))
#define RX_AGG_RING(x)	(((x) & bp->rx_agg_ring_mask) >> (BNXT_PAGE_SHIFT - 4))
#define RX_IDX(x)	((x) & (RX_DESC_CNT - 1))

#define TX_RING(x)	(((x) & bp->tx_ring_mask) >> (BNXT_PAGE_SHIFT - 4))
...
#define RING_RX(idx)		((idx) & bp->rx_ring_mask)
#define NEXT_RX(idx)		((idx) + 1)

#define RING_RX_AGG(idx)	((idx) & bp->rx_agg_ring_mask)
#define NEXT_RX_AGG(idx)	((idx) + 1)

#define RING_TX(idx)		((idx) & bp->tx_ring_mask)
...
#define BNXT_SUPPORTS_MULTI_RSS_CTX(bp) (BNXT_SUPPORTS_NTUPLE_VNIC(bp) && \
					 ((bp)->fw_cap & BNXT_FLAG_MULTI_RSS_CTX))
...
#define BNXT_CTX_TKC	FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_KTLS_TKC
#define BNXT_CTX_RKC	FUNC_BACKING_STORE_QCAPS_V2_REQ_TYPE_KTLS_RKC
...
#define BNXT_CTX_V2_MAX (FUNC_BACKING_STORE_QCAPS_V2_RESP_TYPE_XID_PARTITION + 1)
...
#define BNXT_VPD_FLD_LEN	32
	...
	#define BNXT_FLAG_MULTI_RSS_CTX 0x800
...
#define BNXT_CHIP_SUPPORTS_PHY(bp)	(BNXT_ASIC(bp) || BNXT_CHIP_P7(bp))
	...
	struct mutex		en_ops_lock;	/* sync en_ops */
	struct bnxt_en_dev	*edev;
...
#define	HW_HASH_KEY_SIZE	40
	...
	u32			rss_cap;
#define BNXT_RSS_CAP_AH_V4_RSS_CAP		BIT_ULL(0)
#define BNXT_RSS_CAP_AH_V6_RSS_CAP		BIT_ULL(1)
#define BNXT_RSS_CAP_ESP_V4_RSS_CAP		BIT_ULL(2)
#define BNXT_RSS_CAP_ESP_V6_RSS_CAP		BIT_ULL(3)
#define BNXT_RSS_CAP_RSS_HASH_TYPE_DELTA	BIT_ULL(4)
#define BNXT_RSS_CAP_RSS_TCAM			BIT_ULL(5)
#define BNXT_RSS_CAP_UDP_RSS_CAP		BIT_ULL(6)
#define BNXT_RSS_CAP_NEW_RSS_CAP		BIT_ULL(7)
#define BNXT_RSS_CAP_TOEPLITZ_CAP		BIT_ULL(8)
#define BNXT_RSS_CAP_XOR_CAP			BIT_ULL(9)
#define BNXT_RSS_CAP_IPV6_FLOW_LABEL_CAP        BIT_ULL(10)
#define BNXT_RSS_CAP_TOEPLITZ_CHKSM_CAP		BIT_ULL(11)
...
do {									\
	...
	u16			tf_flags;
	#define	BNXT_TF_FLAG_GFID_ENABLE	0x1
