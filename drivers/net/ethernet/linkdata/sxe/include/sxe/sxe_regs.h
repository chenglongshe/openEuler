...
#define SXE_GCR_EXT_SRIOV (SXE_GCR_EXT_MSIX_EN | SXE_GCR_EXT_VT_MODE_64)
...
#define SXE_EITR(i)                                                            \
	(((i) <= 23) ? (0x00820 + ((i)*4)) : (0x012300 + (((i)-24) * 4)))
...
#define SXE_EIMS_ENABLE_MASK                                                   \
	(SXE_EIMS_RTX_QUEUE | SXE_EIMS_LSC | SXE_EIMS_TCP_TIMER |              \
	 SXE_EIMS_OTHER)
...
#define SXE_SRRCTL(_i)                                                         \
	(((_i) < 64) ? (0x01014 + ((_i)*0x40)) : (0x0D014 + (((_i)-64) * 0x40)))
#define SXE_RDT(_i)                                                            \
	(((_i) < 64) ? (0x01018 + ((_i)*0x40)) : (0x0D018 + (((_i)-64) * 0x40)))
#define SXE_RXDCTL(_i)                                                         \
	(((_i) < 64) ? (0x01028 + ((_i)*0x40)) : (0x0D028 + (((_i)-64) * 0x40)))
#define SXE_LROCTL(_i)                                                         \
...
#define SXE_TPH_RXCTRL(_i)                                                     \
	(((_i) < 64) ? (0x0100C + ((_i)*0x40)) : (0x0D00C + (((_i)-64) * 0x40)))
