...
#define SXE_COMPAT_SFP_NUM                                                     \
	(sizeof(sfp_vendor_pn_list) / sizeof(sfp_vendor_pn_list[0]))
#define SXE_COMPAT_SFP_AOC_NUM                                                 \
	(sizeof(sfp_aoc_vendor_pn_list) / sizeof(sfp_aoc_vendor_pn_list[0]))

STATIC u8 sfp_vendor_pn_list[][SXE_SFP_VENDOR_PN_SIZE] = {
	{ 0x58, 0x50, 0x2d, 0x33, 0x47, 0x31, 0x30, 0x2d, 0x31, 0x30, 0x20,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x58, 0x50, 0x2d, 0x38, 0x47, 0x31, 0x30, 0x2d, 0x30, 0x31, 0x20,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x53, 0x32, 0x31, 0x38, 0x35, 0x2d, 0x30, 0x44, 0x33, 0x43, 0x20,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x59, 0x56, 0x30, 0x32, 0x2d, 0x43, 0x30, 0x31, 0x20, 0x20, 0x20,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x59, 0x56, 0x30, 0x32, 0x2d, 0x43, 0x30, 0x31, 0x2d, 0x30, 0x31,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x50, 0x39, 0x5a, 0x31, 0x53, 0x4d, 0x41, 0x30, 0x31, 0x2d, 0x53,
	  0x44, 0x2d, 0x54, 0x20, 0x20 },

	{ 0x41, 0x46, 0x43, 0x54, 0x2d, 0x37, 0x33, 0x39, 0x53, 0x4d, 0x5a,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x41, 0x46, 0x42, 0x52, 0x2d, 0x37, 0x30, 0x39, 0x44, 0x4d, 0x5a,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x41, 0x46, 0x42, 0x52, 0x2d, 0x37, 0x31, 0x30, 0x53, 0x4d, 0x5a,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x41, 0x46, 0x43, 0x54, 0x2d, 0x37, 0x33, 0x39, 0x44, 0x4d, 0x5a,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x52, 0x54, 0x58, 0x4d, 0x32, 0x32, 0x38, 0x2d, 0x34, 0x30, 0x31,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x53, 0x46, 0x50, 0x2d, 0x4d, 0x4d, 0x38, 0x35, 0x54, 0x47, 0x2d,
	  0x53, 0x33, 0x44, 0x43, 0x20 },

	{ 0x46, 0x54, 0x4c, 0x58, 0x38, 0x35, 0x37, 0x34, 0x44, 0x33, 0x42,
	  0x43, 0x4c, 0x20, 0x20, 0x20 },

	{ 0x46, 0x54, 0x4c, 0x58, 0x38, 0x35, 0x37, 0x34, 0x44, 0x33, 0x42,
	  0x43, 0x56, 0x20, 0x20, 0x20 },

	{ 0x46, 0x54, 0x4c, 0x58, 0x31, 0x34, 0x37, 0x35, 0x44, 0x33, 0x42,
	  0x43, 0x4c, 0x20, 0x20, 0x20 },

	{ 0x46, 0x43, 0x4c, 0x46, 0x38, 0x35, 0x32, 0x32, 0x50, 0x32, 0x42,
	  0x54, 0x4c, 0x20, 0x20, 0x20 },

	{ 0x46, 0x43, 0x42, 0x47, 0x31, 0x31, 0x30, 0x53, 0x44, 0x31, 0x43,
	  0x30, 0x35, 0x20, 0x20, 0x20 },

	{ 0x41, 0x46, 0x42, 0x52, 0x2d, 0x37, 0x30, 0x39, 0x44, 0x4d, 0x5a,
	  0x2d, 0x49, 0x4e, 0x33, 0x20 },

	{ 0x58, 0x50, 0x41, 0x43, 0x2d, 0x38, 0x47, 0x31, 0x30, 0x2d, 0x30,
	  0x35, 0x20, 0x20, 0x20, 0x20 },

	{ 0x58, 0x50, 0x44, 0x43, 0x2d, 0x47, 0x31, 0x30, 0x2d, 0x30, 0x32,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x52, 0x54, 0x58, 0x4d, 0x32, 0x32, 0x38, 0x2d, 0x35, 0x35, 0x31,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x53, 0x50, 0x4c, 0x5a, 0x2d, 0x38, 0x35, 0x53, 0x52, 0x43, 0x20,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x4c, 0x54, 0x46, 0x38, 0x35, 0x30, 0x32, 0x2d, 0x42, 0x43, 0x2b,
	  0x20, 0x20, 0x20, 0x20, 0x20 },

	{ 0x49, 0x4e, 0x2d, 0x53, 0x50, 0x31, 0x30, 0x31, 0x53, 0x52, 0x4c,
	  0x43, 0x20, 0x20, 0x20, 0x20 },

	{ 0x47, 0x53, 0x53, 0x2d, 0x4d, 0x44, 0x4f, 0x31, 0x30, 0x30, 0x2d,
	  0x30, 0x30, 0x37, 0x43, 0x20 },
};
...
int sxe_mdio_read(struct net_device *netdev, int prtad, int devad, u16 addr)
{
	...
	if (prtad != adapter->phy_ctxt.phy_info.mdio.prtad) {
		LOG_ERROR_BDF(
			"not the current phy, prted=%d, current prted=%d\n",
...
static s32 sxe_mii_bus_read(struct mii_bus *bus, int addr, int regnum)
{
	...
	if (ret) {
		LOG_ERROR_BDF(
			"mii read failed, reg_addr=%d, device_type=%d, prtad=%d\n",
...
static bool sxe_phy_probe(struct sxe_adapter *adapter, u16 phy_addr)
{
	...
	if (SXE_PHY_UNKNOWN == phy->type) {
		...
		if (ret) {
			LOG_ERROR_BDF(
				"get phy extended ability failed, prtad=%d\n",
				phy_addr);
			goto l_end;
		}
...
s32 sxe_phy_identify(struct sxe_adapter *adapter)
{
	...
	for (phy_addr = 0; phy_addr < SXE_PHY_ADDR_MAX; phy_addr++) {
		...
		if (!ret) {
			LOG_INFO_BDF(
				"phy probe seccess, prtad=%d, phy_type=%d\n",
				   ...
				   bool *autoneg)
{
	...
	*autoneg = true;
	...
	ret = adapter->hw.phy.ops->link_cap_get(
		hw, adapter->phy_ctxt.phy_info.mdio.prtad, speed);
	if (ret) {
			...
			u8 *data)
{
	...
	if (len > SXE_SFP_EEPROM_SIZE_MAX) {
		ret = -EINVAL;
		LOG_ERROR_BDF(
			"sfp read size[%u] > eeprom max size[%d], ret=%d\n",
	...
	if (ret) {
		LOG_ERROR_BDF(
			"sfp read, hdc failed, offset=%u, len=%u, ret=%d\n",
			offset, len, ret);
		ret = -EIO;
		goto l_free;
	}
			 ...
			 u8 *data)
{
	...
	if (len > SXE_SFP_EEPROM_SIZE_MAX) {
		ret = -EINVAL;
		LOG_ERROR_BDF(
			"sfp write size[%u] > eeprom max size[%d], ret=%d\n",
			len, SXE_SFP_EEPROM_SIZE_MAX, ret);
		goto l_end;
	}
...
s32 sxe_multispeed_sfp_link_configure(struct sxe_adapter *adapter, u32 speed)
{
	...
	if (speed & SXE_LINK_SPEED_10GB_FULL) {
		...
		for (i = 0; i < SXE_LINK_UP_RETRY_CNT; i++) {
			...
			if (link_up) {
				LOG_INFO_BDF(
					"link cfg end, link up, speed is 10G\n");
				goto l_out;
			}
		}
...
STATIC s32 sxe_an_cap_get(struct sxe_adapter *adapter, sxe_an_cap_s *an_cap)
{
	...
	if (ret) {
		LOG_ERROR_BDF(
			"hdc trans failed ret=%d, cmd:negotiation cap get\n",
			ret);
	}
...
s32 sxe_sfp_identify(struct sxe_adapter *adapter)
{
	...
	if (0 == ret) {
		...
		LOG_INFO_BDF(
			"an supported AOC SFP module type was detected,spp_configure is 15ms\n");
	} else {
		adapter->hw.irq.ops->spp_configure(&adapter->hw,
						   SXE_SPP_PROC_DELAY_US);
		LOG_INFO_BDF(
			"an unsupported AOC SFP module type was detected,spp_configure is default 7us\n");
		ret = 0;
	}
...
struct sxe_phy_ops phy_ops[SXE_PHY_MAX] = {
	...
	{ sxe_phy_identify, sxe_phy_link_speed_configure,
	  sxe_phy_link_capabilities_get, sxe_phy_reset, NULL, NULL },
#endif
};
