...
static int fxgmac_channels_alloc(struct fxgmac_pdata *pdata)
{
	...
	if (netif_msg_drv(pdata))
		yt_dbg(pdata, "alloc_channels,channel_head=%p,channel_count=%d\n",
	...
	if (netif_msg_drv(pdata))
		yt_dbg(pdata, "alloc_channels,tx_ring=%p,channel_count=%d\n",
	...
	if (netif_msg_drv(pdata))
		yt_dbg(pdata, "alloc_channels,rx_ring=%p,channel_count=%d\n",
