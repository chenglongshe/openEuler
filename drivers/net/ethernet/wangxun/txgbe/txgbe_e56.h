...
#define EPHY_WREG(REG)			txgbe_wr32_ephy(hw, REG##_ADDR, rdata)
...
#define EPCS_WREG(REG)			txgbe_wr32_epcs(hw, REG##_ADDR, rdata)
...
union txgbe_e56_cms_ana_ovrdval0 {
	struct {
...
union txgbe_e56_cms_ana_ovrdval7 {
	struct {
...
union txgbe_e56_cms_ana_ovrden1 {
	struct {
...
union txgbe_e56_cms_ana_ovrdval9 {
	struct {
...
union txgbe_e56_rxs0_osc_cal_n_cdr4 {
	struct {
...
union txgbe_e56_rxs0_intl_config0 {
	struct {
