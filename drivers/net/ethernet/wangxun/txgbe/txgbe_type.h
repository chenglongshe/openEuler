...
#define TXGBE_MDIO_AUTO_NEG_LP_STATUS            0xE820 /* AUTO NEG RX LP Status Reg */
...
#define TXGBE_I2C_HS_SCL_HCNT           0x14924
#define TXGBE_I2C_HS_SCL_LCNT           0x14928
#define TXGBE_I2C_INTR_STAT             0x1492C
#define TXGBE_I2C_RAW_INTR_STAT         0x14934
#define TXGBE_I2C_INTR_STAT_RX_FULL     ((0x1) << 2)
#define TXGBE_I2C_INTR_STAT_TX_EMPTY    ((0x1) << 4)
#define TXGBE_I2C_INTR_MASK             0x14930
#define TXGBE_I2C_RX_TL                 0x14938
#define TXGBE_I2C_TX_TL                 0x1493C
#define TXGBE_I2C_CLR_INTR              0x14940
#define TXGBE_I2C_CLR_RX_UNDER          0x14944
#define TXGBE_I2C_CLR_RX_OVER           0x14948
#define TXGBE_I2C_CLR_TX_OVER           0x1494C
#define TXGBE_I2C_CLR_RD_REQ            0x14950
#define TXGBE_I2C_CLR_TX_ABRT           0x14954
#define TXGBE_I2C_CLR_RX_DONE           0x14958
#define TXGBE_I2C_CLR_ACTIVITY          0x1495C
#define TXGBE_I2C_CLR_STOP_DET          0x14960
#define TXGBE_I2C_CLR_START_DET         0x14964
#define TXGBE_I2C_CLR_GEN_CALL          0x14968
#define TXGBE_I2C_ENABLE                0x1496C
#define TXGBE_I2C_STATUS                0x14970
#define TXGBE_I2C_STATUS_MST_ACTIVITY   ((1U << 5))
#define TXGBE_I2C_TXFLR                 0x14974
#define TXGBE_I2C_RXFLR                 0x14978
#define TXGBE_I2C_SDA_HOLD              0x1497C
#define TXGBE_I2C_SDA_RX_HOLD           0xff0000
#define TXGBE_I2C_SDA_TX_HOLD           0xffff

#define TXGBE_I2C_TX_ABRT_SOURCE        0x14980
#define TXGBE_I2C_SDA_SETUP             0x14994
#define TXGBE_I2C_ENABLE_STATUS         0x1499C
#define TXGBE_I2C_FS_SPKLEN             0x149A0
#define TXGBE_I2C_HS_SPKLEN             0x149A4
#define TXGBE_I2C_SCL_STUCK_TIMEOUT     0x149AC
#define TXGBE_I2C_SDA_STUCK_TIMEOUT     0x149B0
#define TXGBE_I2C_CLR_SCL_STUCK_DET     0x149B4
#define TXGBE_I2C_DEVICE_ID             0x149b8
#define TXGBE_I2C_COMP_PARAM_1          0x149f4
#define TXGBE_I2C_COMP_VERSION          0x149f8
#define TXGBE_I2C_COMP_TYPE             0x149fc
...
#define TXGBE_PSR_ETYPE_SWC_POOL_ENABLE         BIT(26) /* bit 26 */
...
#define TXGBE_PX_TR_CFG_HEAD_WB         BIT(27) /* amlite head wb */
#define TXGBE_PX_TR_CFG_HEAD_WB_64BYTE  BIT(28) /* amlite head wb 64byte */
...
#define TXGBE_PX_RR_CFG_BSIZEHDRSIZE_SHIFT      6
...
struct txgbe_eeprom_operations {
	...
	s32 (*read_buffer)(struct txgbe_hw *hw, u16 offset, u16 words, u16 *data);
	s32 (*write)(struct txgbe_hw *hw, u16 offset, u16 data);
	s32 (*write_buffer)(struct txgbe_hw *hw, u16 offset, u16 words, u16 *data);
...
struct txgbe_flash_operations {
	s32 (*init_params)(struct txgbe_hw *hw);
	s32 (*read_buffer)(struct txgbe_hw *hw, u32 offset, u32 dwords, u32 *data);
	s32 (*write_buffer)(struct txgbe_hw *hw, u32 offset, u32 dwords, u32 *data);
};
...
struct txgbe_mac_operations {
	...
	s32 (*get_wwn_prefix)(struct txgbe_hw *hw, u16 *wwnn_prefix, u16 *wwpn_prefix);
	...
	s32 (*setup_mac_link)(struct txgbe_hw *hw,
			      u32 speed,
			       bool autoneg_wait_to_complete);
	...
	/* RAR, Multicast, VLAN */
	s32 (*set_rar)(struct txgbe_hw *hw, u32 index, u8 *addr, u64 pools, u32 enable_addr);
	s32 (*clear_rar)(struct txgbe_hw *hw, u32 index);
	s32 (*insert_mac_addr)(struct txgbe_hw *hw, u8 *addr, u32 vmdq);
	...
	s32 (*update_mc_addr_list)(struct txgbe_hw *hw, u8 *mc_addr_list,
				   u32 mc_addr_count, txgbe_mc_addr_itr next,
				      bool clear);
	s32 (*enable_mc)(struct txgbe_hw *hw);
	s32 (*disable_mc)(struct txgbe_hw *hw);
	s32 (*clear_vfta)(struct txgbe_hw *hw);
	s32 (*set_vfta)(struct txgbe_hw *hw, u32 vlan, u32 vind,
			bool vlan_on);
	s32 (*set_vlvf)(struct txgbe_hw *hw, u32 vlan, u32 vind,
			bool vlan_on, bool *vfta_changed);
	s32 (*init_uta_tables)(struct txgbe_hw *hw);
	void (*set_mac_anti_spoofing)(struct txgbe_hw *hw, bool enable, int pf);
...
struct txgbe_phy_operations {
	...
	s32 (*write_reg_mdi)(struct txgbe_hw *hw, u32 reg_addr,
			     u32 device_type, u16 phy_data);
	u32 (*setup_link)(struct txgbe_hw *hw, u32 speed_set, bool autoneg_wait_to_complete);
	u32 (*setup_link_speed)(struct txgbe_hw *hw,
				u32 speed,
				       bool autoneg_wait_to_complete);
	s32 (*get_firmware_version)(struct txgbe_hw *hw,
...
struct txgbe_mbx_operations {
	...
	s32 (*write)(struct txgbe_hw *hw, u32 *msg, u16 size, u16 vf);
	...
	s32 (*check_for_msg)(struct txgbe_hw *hw, u16 __always_unused mbx_id);
	s32 (*check_for_ack)(struct txgbe_hw *hw, u16 __always_unused mbx_id);
	s32 (*check_for_rst)(struct txgbe_hw *hw, u16 __always_unused mbx_id);
};
