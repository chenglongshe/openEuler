...
#define NBL_FLOW_KEY_TABLE_IDX_FLAG			(1ULL << 0)
#define NBL_FLOW_KEY_INPORT8_FLAG			(1ULL << 1)
#define NBL_FLOW_KEY_INPORT4_FLAG			(1ULL << 39)
#define NBL_FLOW_KEY_INPORT2_FLAG			(1ULL << 40)	// error
#define NBL_FLOW_KEY_INPORT2L_FLAG			(1ULL << 41)	// error
#define NBL_FLOW_KEY_T_DIPV4_FLAG			(1ULL << 2)
#define NBL_FLOW_KEY_T_DIPV6_FLAG			(1ULL << 3)
#define NBL_FLOW_KEY_T_OPT_DATA_FLAG			(1ULL << 4)
#define NBL_FLOW_KEY_T_VNI_FLAG				(1ULL << 5)
#define NBL_FLOW_KEY_T_DSTMAC_FLAG			(1ULL << 6)	// error
#define NBL_FLOW_KEY_T_SRCMAC_FLAG			(1ULL << 7)	// error
#define NBL_FLOW_KEY_T_SVLAN_FLAG			(1ULL << 8)	// error
#define NBL_FLOW_KEY_T_CVLAN_FLAG			(1ULL << 9)	// error
#define NBL_FLOW_KEY_T_ETHERTYPE_FLAG			(1ULL << 10)	// error
#define NBL_FLOW_KEY_T_SRCPORT_FLAG			(1ULL << 11)
#define NBL_FLOW_KEY_T_DSTPORT_FLAG			(1ULL << 12)
#define NBL_FLOW_KEY_T_NPROTO_FLAG			(1ULL << 13)	// delete
#define NBL_FLOW_KEY_T_OPT_CLASS_FLAG			(1ULL << 14)
#define NBL_FLOW_KEY_T_PROTOCOL_FLAG			(1ULL << 15)
#define NBL_FLOW_KEY_T_TCPSTAT_FLAG			(1ULL << 16) 	// delete
#define NBL_FLOW_KEY_T_TOS_FLAG				(1ULL << 17)
#define NBL_FLOW_KEY_T_TTL_FLAG				(1ULL << 18)
#define NBL_FLOW_KEY_SIPV4_FLAG				(1ULL << 19)
#define NBL_FLOW_KEY_SIPV6_FLAG				(1ULL << 20)
#define NBL_FLOW_KEY_DIPV4_FLAG				(1ULL << 21)
#define NBL_FLOW_KEY_DIPV6_FLAG				(1ULL << 22)
#define NBL_FLOW_KEY_DSTMAC_FLAG			(1ULL << 23)
#define NBL_FLOW_KEY_SRCMAC_FLAG			(1ULL << 24)
#define NBL_FLOW_KEY_SVLAN_FLAG				(1ULL << 25)
#define NBL_FLOW_KEY_CVLAN_FLAG				(1ULL << 26)
#define NBL_FLOW_KEY_ETHERTYPE_FLAG			(1ULL << 27)
#define NBL_FLOW_KEY_SRCPORT_FLAG			(1ULL << 28)
#define NBL_FLOW_KEY_ICMP_TYPE_FLAG			(1ULL << 28)
#define NBL_FLOW_KEY_DSTPORT_FLAG			(1ULL << 29)
#define NBL_FLOW_KEY_ICMP_CODE_FLAG			(1ULL << 29)
#define NBL_FLOW_KEY_ARP_OP_FLAG			(1ULL << 30)	// error
#define NBL_FLOW_KEY_ICMPV6_TYPE_FLAG			(1ULL << 31)	// error
#define NBL_FLOW_KEY_PROTOCOL_FLAG			(1ULL << 32)
#define NBL_FLOW_KEY_TCPSTAT_FLAG			(1ULL << 33)
#define NBL_FLOW_KEY_TOS_FLAG				(1ULL << 34)
#define NBL_FLOW_KEY_DSCP_FLAG				(1ULL << 34)
#define NBL_FLOW_KEY_TTL_FLAG				(1ULL << 35)
#define NBL_FLOW_KEY_HOPLIMIT_FLAG			(1ULL << 35)
#define NBL_FLOW_KEY_RDMA_ACK_SEQ_FLAG			(1ULL << 36)	// error
#define NBL_FLOW_KEY_RDMA_QPN_FLAG			(1ULL << 37)	// error
#define NBL_FLOW_KEY_RDMA_OP_FLAG			(1ULL << 38)	// error
#define NBL_FLOW_KEY_EXEHASH_FLAG			(1ULL << 43)
#define NBL_FLOW_KEY_DPHASH_FLAG			(1ULL << 44)
#define NBL_FLOW_KEY_RECIRC_FLAG			(1ULL << 63)

/* action flag */
#define NBL_FLOW_ACTION_METADATA_FLAG			(1ULL << 1)
#define NBL_FLOW_ACTION_DROP				(1ULL << 2)
#define NBL_FLOW_ACTION_REDIRECT			(1ULL << 3)
#define NBL_FLOW_ACTION_MIRRED				(1ULL << 4)
#define NBL_FLOW_ACTION_TUNNEL_ENCAP			(1ULL << 5)
#define NBL_FLOW_ACTION_TUNNEL_DECAP			(1ULL << 6)
#define NBL_FLOW_ACTION_COUNTER				(1ULL << 7)
#define NBL_FLOW_ACTION_SET_IPV4_SRC_IP			(1ULL << 8)
#define NBL_FLOW_ACTION_SET_IPV4_DST_IP			(1ULL << 9)
#define NBL_FLOW_ACTION_SET_IPV6_SRC_IP			(1ULL << 10)
#define NBL_FLOW_ACTION_SET_IPV6_DST_IP			(1ULL << 11)
#define NBL_FLOW_ACTION_SET_SRC_MAC			(1ULL << 12)
#define NBL_FLOW_ACTION_SET_DST_MAC			(1ULL << 13)
#define NBL_FLOW_ACTION_SET_SRC_PORT			(1ULL << 14)
#define NBL_FLOW_ACTION_SET_DST_PORT			(1ULL << 15)
#define NBL_FLOW_ACTION_SET_TTL				(1ULL << 16)
#define NBL_FLOW_ACTION_SET_IPV4_DSCP			(1ULL << 17)
#define NBL_FLOW_ACTION_SET_IPV6_DSCP			(1ULL << 18)
#define NBL_FLOW_ACTION_RSS				(1ULL << 19)
#define NBL_FLOW_ACTION_QUEUE				(1ULL << 20)
#define NBL_FLOW_ACTION_MARK				(1ULL << 21)
#define NBL_FLOW_ACTION_PUSH_INNER_VLAN			(1ULL << 22)
#define NBL_FLOW_ACTION_PUSH_OUTER_VLAN			(1ULL << 23)
#define NBL_FLOW_ACTION_POP_INNER_VLAN			(1ULL << 24)
#define NBL_FLOW_ACTION_POP_OUTER_VLAN			(1ULL << 25)
#define NBL_FLOW_ACTION_REPLACE_INNER_VLAN		(1ULL << 26)
#define NBL_FLOW_ACTION_REPLACE_SINGLE_INNER_VLAN	(1ULL << 27)
#define NBL_FLOW_ACTION_REPLACE_OUTER_VLAN		(1ULL << 28)
#define NBL_FLOW_ACTION_PHY_PORT			(1ULL << 29)
#define NBL_FLOW_ACTION_PORT_ID				(1ULL << 30)
#define NBL_FLOW_ACTION_INGRESS				(1ULL << 31)
#define NBL_FLOW_ACTION_EGRESS				(1ULL << 32)
#define NBL_FLOW_ACTION_IPV4				(1ULL << 33)
#define NBL_FLOW_ACTION_IPV6				(1ULL << 34)
#define NBL_FLOW_ACTION_CAR				(1ULL << 35)
#define NBL_FLOW_ACTION_MCC				(1ULL << 36)
#define NBL_FLOW_ACTION_MIRRED_ENCAP			(1ULL << 37)
#define NBL_FLOW_ACTION_META_RECIRC			(1ULL << 38)
#define NBL_FLOW_ACTION_STAT				(1ULL << 39)
#define NBL_ACTION_FLAG_OFFSET_MAX			(1ULL << 40)
