...
#define HISI_SDMA_U32_MSK			0xFFFFFFFF
/* REG_FILED_MASK IN HISI_SDMA_CH_CTRL_REG */
#define HISI_SDMA_CH_ENABLE_MSK			0x00000001

/* REG_FILED_MASK IN HISI_SDMA_CH_TEST_REG */
#define HISI_SDMA_CH_PAUSE_MSK			0x00000001
#define HISI_SDMA_CH_RESUME_MSK			0x00000002
#define HISI_SDMA_CH_RESET_MSK			0x00000004

/* HISI_SDMA_CH_FSM_STATUS VAL */
#define HISI_SDMA_CHN_FSM_IDLE_MSK		0x00000001
#define HISI_SDMA_CHN_FSM_RUNNING_MSK		0x00000002
#define HISI_SDMA_CHN_FSM_ABORT_MSK		0x00000004
#define HISI_SDMA_CHN_FSM_PAUSE_MSK		0x00000008
#define HISI_SDMA_CHN_FSM_QUIESCENT_MSK		0x00000010

/* HISI_SDMA_IRQ_STATUS */
#define HISI_SDMA_CHN_IRQ_STATUS_MSK		0x0FF00000
#define HISI_SDMA_CHN_CQE_STATUS_MSK		0x0000003E
#define HISI_SDMA_CHN_CQE_SQEID_MSK		0x003FFFC0

/* HISI_SDMA_CH_DFX_INFO0 */
#define HISI_SDMA_CHN_NORMAL_SQE_CNT_MSK	0xFFFF0000
#define HISI_SDMA_CHN_ERROR_SQE_CNT_MSK		0x0000FFFF
