...
#define zcopy_set_pmd_at(mm, addr, pmdp, pmd)	\
	zcopy_set_pte_at(mm, addr, (pte_t *)pmdp, pmd_pte(pmd))
...
static inline void zcopy_set_pte_at(struct mm_struct *mm, unsigned long addr,
