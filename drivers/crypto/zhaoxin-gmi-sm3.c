...
/*
 * zx-gmi-sm3.c - wrapper code for Zhaoxin GMI.
 *
...
static int zx_sm3_update(struct shash_desc *desc, const u8 *data,
		unsigned int len)
{
...
static int zx_sm3_finup(struct shash_desc *desc, const u8 *data,
