...
> Note: Directories whose configs are not present in `openeuler_defconfig` (see the “Review-needed directories” section below) should be evaluated against actual server hardware needs.
