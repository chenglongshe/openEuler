...
struct kvm_pmu {
	...
	u64 fixed_ctr_ctrl;
	KABI_REPLACE(u64 fixed_ctr_ctrl_mask, u64 fixed_ctr_ctrl_rsvd)
	u64 global_ctrl;
	u64 global_status;
	u64 counter_bitmask[2];
	KABI_REPLACE(u64 global_ctrl_mask, u64 global_ctrl_rsvd)
	KABI_REPLACE(u64 global_status_mask, u64 global_status_rsvd)
	u64 reserved_bits;
	u64 raw_event_mask;
	...
	u64 ds_area;
	u64 pebs_enable;
	KABI_REPLACE(u64 pebs_enable_mask, u64 pebs_enable_rsvd)
	u64 pebs_data_cfg;
	KABI_REPLACE(u64 pebs_data_cfg_mask, u64 pebs_data_cfg_rsvd)
...
#define kvm_arch_has_private_mem(kvm) ((kvm)->vm_type != KVM_X86_DEFAULT_VM)
#else
