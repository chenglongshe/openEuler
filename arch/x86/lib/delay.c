 ...
 */
static void __delay_pauseopt(u64 unused, u64 cycles)
{
	u64 until = cycles;
	u32 eax, edx;
 ...
 */
static void delay_pauseopt(unsigned long __cycles)
{
...
void use_pauseopt_delay(void)
{
	delay_fn = delay_pauseopt;
}
