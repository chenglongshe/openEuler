...
static struct akcipher_alg zhaoxin_sm2 = {
	...
	.base = {
		.cra_name = "sm2",
		.cra_driver_name = "sm2-zhaoxin-gmi",
		.cra_priority = 150,
...
static const struct x86_cpu_id zhaoxin_sm2_cpu_ids[] = {
	X86_MATCH_VENDOR_FEATURE(CENTAUR, X86_FEATURE_SM2, NULL),
	X86_MATCH_VENDOR_FEATURE(ZHAOXIN, X86_FEATURE_SM2, NULL),
	{}
};
...
MODULE_ALIAS_CRYPTO("sm2-zhaoxin-gmi");
