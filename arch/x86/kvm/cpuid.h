...
static __always_inline u32 __feature_translate(int x86_feature)
{
	...
	else if (x86_feature == X86_FEATURE_LFENCE_RDTSC)
		return KVM_X86_FEATURE_LFENCE_RDTSC;
	else if (x86_feature == X86_FEATURE_NULL_SEL_CLR_BASE)
		return KVM_X86_FEATURE_NULL_SEL_CLR_BASE;
