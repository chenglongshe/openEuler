 ...
 * vdie is equivalent to cpu die.
 */

#define DVMBM_VDIE1_SHIFT_HIP12			57
#define DVMBM_VDIE2_SHIFT_HIP12			53
#define DVMBM_VDIE1_CLUSTER_SHIFT_HIP12		6
#define DVMBM_VDIE2_CLUSTER_SHIFT_HIP12		0
#define DVMBM_MAX_VDIES_HIP12			8
#define MPIDR_AFF3_VDIE_ID_MASK			GENMASK(2, 0)
