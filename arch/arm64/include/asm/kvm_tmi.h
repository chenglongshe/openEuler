...
#define TMI_CVM_PARAM_FLAG_MIG		BIT(3)
#define TMI_CVM_PARAM_FLAG_MIGVM	BIT(4)
...
typedef enum tmi_tmm_mig_control_fid_e {
...
typedef enum tmi_tmm_mig_data_fid_e{
	...
	TMI_TMM_MIG_EXPORT_MUTABLE,
	TMI_TMM_MIG_IMPORT_MUTABLE,
	TMI_TMM_MIG_IS_ZERO_PAGE,
	TMI_TMM_MIG_IMPORT_ZERO_PAGE
} tmi_tmm_mig_data_fid_t;

typedef enum tmi_tmm_mig_attestation_fid_e{
	TMI_TMM_MIGVM_INIT,
	TMI_TMM_MIGVM_CLEAN,
	TMI_TMM_MIG_BIND,
	TMI_TMM_MIG_BIND_CLEAN,
	TMI_TMM_MIG_BIND_PEEK
} tmi_tmm_mig_attestation_fid_t;

#define KVM_CAP_ARM_TMM_MIGRATION_CAP_DISABLE		0
#define KVM_CAP_ARM_TMM_MIGRATION_CAP_LIVE_SRC		1
#define KVM_CAP_ARM_TMM_MIGRATION_CAP_LIVE_DST		2

#define KVM_CAP_ARM_TMM_MIGVM_DEFAULT		0
#define KVM_CAP_ARM_TMM_MIGVM_ENABLE		1

#define TMI_ABI_VERSION_MIG				U(0x3)
