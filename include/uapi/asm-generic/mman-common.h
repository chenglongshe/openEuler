...
#define MAP_PEER_SHARED		0x2000000 /* GMEM scene, for heterogeneous memory */
...
/* some madvise for heterogeneous memory only GMEM scene */
...
#define MADV_UNPINNED	(MADV_GMEM_BASE+2)	/* unpin these pages */
