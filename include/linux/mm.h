...
/* Hardcode the MIN macro in the below commit:
 ...
 */
#define PP_DMA_INDEX_BITS PP_MIN(32, __ffs(POISON_POINTER_DELTA) - PP_DMA_INDEX_SHIFT)
#else
/* Always leave out the topmost two; see above. */
#define PP_DMA_INDEX_BITS PP_MIN(32, BITS_PER_LONG - PP_DMA_INDEX_SHIFT - 2)
#endif
