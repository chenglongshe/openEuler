...
struct ub_error_handlers {
	...
	void (*reset_prepare)(struct ub_entity *uent);
	void (*reset_done)(struct ub_entity *uent);
	ub_ers_result_t (*error_detected)(struct ub_entity *uent, ub_channel_state_t state);
	ub_ers_result_t (*resource_enabled)(struct ub_entity *uent);
};
