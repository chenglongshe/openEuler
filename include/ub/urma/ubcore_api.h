...
/**
 * MUE receives msg from UE or MUE, called only by driver.
...
/**
 * UE or MUE receives msg from MUE, called only by driver.
...
/**
 * Ubcore dispatches provider management event
