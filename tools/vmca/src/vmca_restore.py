...
#
# vmca restore helper — restores global CPU map state on boot
#
# Called by vmca-restore.service after system startup.
...
GLOBAL_MAP_FILE = "/etc/vmca/global_cpu_map.json"

logger = logging.getLogger("vmca-restore")
