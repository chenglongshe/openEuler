...
//
// vmca_intercept.bpf.c — eBPF CO-RE program for sched_setaffinity interception
//
...
//         -I/usr/include/bpf -I. \
//         -c vmca_intercept.bpf.c -o vmca_intercept.bpf.o
//   bpftool gen skeleton vmca_intercept.bpf.o > vmca_intercept.skel.h
//
