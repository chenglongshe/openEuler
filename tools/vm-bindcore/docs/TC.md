...
| 测试用例 | SR AC | US AC | 覆盖场景 |
|----------|-------|-------|----------|
| TC-01 | AC-SR-01 | AC-US-01-01, AC-US-03-01 | 单 VM 绑核端到端 |
| TC-02 | AC-SR-02 | AC-US-04-01, AC-US-04-02 | 自动解绑恢复 |
