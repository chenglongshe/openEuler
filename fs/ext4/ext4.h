...
#ifndef CONFIG_EXT4_PARALLEL_DIO_READ
...
#else
#define ext4_inode_block_unlocked_dio(inode)
#define ext4_inode_resume_unlocked_dio(inode)
#endif
...
extern int ext4_block_write_begin(struct page *page, loff_t pos, unsigned len,
