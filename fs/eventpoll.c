...
DEFINE_HASHTABLE(xcall_item_table, PREFETCH_ITEM_HASH_BITS);
DEFINE_RAW_SPINLOCK(xcall_table_lock);
...
struct prefetch_item *find_prefetch_item(struct file *file)
{
	...
	raw_spin_lock(&xcall_table_lock);
